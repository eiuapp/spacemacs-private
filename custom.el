 ...
 '(safe-local-variable-values
   (quote
    ...
    ((eval add-hook
     ...
     (eval setenv "PYTHONPATH" "~/cocos2d-x/tools/cocos2d-console/plugins:~/cocos2d-x/tools/cocos2d-console/bin"))))
