...
;;
;; Copyright (c) 2014-2016 tomtsang
;;
;; Author: guanghui <guanghui8827@gmail.com>
;; URL: https://github.com/tomtsang/spacemacs-private
;;
...
(defconst tomtsang-org-packages
  '(
...
(defun tomtsang-org/post-init-evil-org ()
      ...
      (setq org-capture-templates
            '(("t" "Todo" entry (file+headline org-agenda-file-gtd "Workspace")
              ...
              ("c" "Chrome" entry (file+headline org-agenda-file-note "Quick notes")
               "* TODO [#C] %?\n %(tomtsang/retrieve-chrome-current-tab-url)\n %i\n %U"
               :empty-lines 1)
...
See `org-capture-templates' for more information."
      ...
      (setq org-agenda-custom-commands
            '(
              ...
              ("pl" tags-todo "PROJECT+DREAM+CATEGORY=\"tomtsang\"")
              ("W" "Weekly Review"
...
(defun tomtsang-org/init-org-mac-link ()
...
(defun tomtsang-org/post-init-ox-reveal ()
  (setq org-reveal-root "file:///Users/guanghui/.emacs.d/reveal-js"))


(defun tomtsang-org/init-org-tree-slide ()
  (use-package org-tree-slide
    :init
    (spacemacs/set-leader-keys "oto" 'org-tree-slide-mode)))


(defun tomtsang-org/init-org-download ()
  (use-package org-download
    :defer t
    :init
    (org-download-enable)))

(defun tomtsang-org/init-plain-org-wiki ()
  (use-package plain-org-wiki
    :init
    (setq pow-directory "~/org-notes")))

(defun tomtsang-org/init-ob-typescript ()
  (use-package ob-typescript
    :init))

(defun tomtsang-org/init-worf ()
  (use-package worf
    :defer t
    :init
    (add-hook 'org-mode-hook 'worf-mode)))

(defun tomtsang-org/post-init-deft ()
  (progn
...
(defun tomtsang-org/init-sound-wav ()
